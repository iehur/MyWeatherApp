...
public class WeatherModel implements Parcelable {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeParcelable(this.currentWeatherModel, flags);
        dest.writeList(this.dailyWeatherList);
    ...
    private WeatherModel(Parcel in) {
        ...
        this.currentWeatherModel = in.readParcelable(CurrentWeatherModel.class.getClassLoader());
        this.dailyWeatherList = new ArrayList<>();
        in.readList(this.dailyWeatherList, DailyWeatherModel.class.getClassLoader());
        this.alerts = new ArrayList<>();
        in.readList(this.alerts, AlertModel.class.getClassLoader());
    }
